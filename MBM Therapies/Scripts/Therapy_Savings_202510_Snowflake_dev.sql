...
create table tmp_1m.kn_mbm_dtl_202510 as 					
select 			
	fin_mbi_hicn_fnl			
	, fin_inc_month			
	, fin_inc_qtr 		
...
create temporary table tmp_1m.kn_mbm_mshp_202510 as
select
...
create table tmp_1m.kn_mbm_mshp_sum1_202510 as
select 
	'MM' as data_type
	, ep_start_mo
	, '' as visit_mo
...
create table tmp_1m.kn_mbm_episode_pr_202510 as
select
...
--select count(*) from tmp_1m.kn_mbm_episode_pr_202510; -- 66530074 64354173  62711063  60990327
...
create table tmp_1m.kn_mbm_op_claims as
select
    e.*
...
--select count(*) from tmp_1m.kn_mbm_episode_op_202510; -- 39607841 40613266 38657890  37706450  36737912  35885437
...
--select count(*) from tmp_1m.kn_mbm_episode_1c_202510; -- 144378922 146949829 136759944 134268620 141253070  138658520  135969246
--
...
--select count(*) from tmp_1m.kn_mbm_episode_2_202510; -- 144378922 134268620 141253070  138658520  135969246
--
...
create table tmp_1m.kn_mbm_episode_agg6_sum1_after2023_202510 as 
select 
	data_type,
	ep_start_mo,
