...
where fst_srvc_month between '202101' and '202110'
...
select count(*) from fichsrv.cosmos_pr
where fst_srvc_month between '202101' and '202108';
...
where serv_month between '202409' and '202410'
group by serv_month
...
select count(*) from tmp_1m.kn_mbm_episode_agg6;
-- 2049673
