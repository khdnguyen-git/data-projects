...
--select sum(allowed) from tmp_1m.kn_mbm_episode_pr_202509
...
drop table if exists tmp_1m.kn_mbm_episode_1c_202509;
create table tmp_1m.kn_mbm_episode_1c_202509 as
...
--select count(*) from tmp_1m.kn_mbm_episode_1c_202509; -- 136759944 134268620 141253070  138658520  135969246
--
--select * from tmp_1m.kn_mbm_episode_1c_202509 limit 2;
--select serv_month, sum(allowed) as allowedamt 
--from tmp_1m.kn_mbm_episode_1c_202509
...
from (select a.*, tin_num  			
      from (select *
             ...
             from tmp_1m.kn_mbm_episode_1c_202509) as a 			
...
--
--describe formatted tmp_1m.kn_mbm_episode_2_202509;
...
select count(*) from tmp_1m.kn_mbm_202509; -- 257905 253665
;
