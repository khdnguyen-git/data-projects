...
select population, sum(mbr_count)
from tmp_1m.knd_mbm_vpe_summary_${paid_thru}
where population != 'N/A'
	and ep_start_month >= '202501'
	and category_1 in ('Other', 'Chiro')
group by 1


select tin from tmp_1y.cl_therapy_optum_tins_202602 where tin ilike '061170751'
...
where population != 'NA' 
	and ep_start_month >= '202501'
	and category not in ('Other', 'Chiro')
group by 
	population
	, prov_tin
