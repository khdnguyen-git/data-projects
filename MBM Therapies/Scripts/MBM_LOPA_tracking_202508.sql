...
select * from tmp_1m.kn_mbm_episode_2_202508 limit 2;
...
drop table tmp_7d.kn_mbm_lopa_tracking_1;
...
where 
	PROV_PRTCP_STS_CD='P' AND
	serv_month > '202109'
;
--74609604 select count(*) from tmp_7d.kn_mbm_lopa_tracking_1
...
drop table tmp_7d.kn_mbm_lopa_tracking_1_Rehab;
...
category = 'OP_REHAB'
;
--23965099 select count(*) from tmp_7d.kn_mbm_lopa_tracking_1_Rehab

drop table tmp_7d.kn_mbm_lopa_tracking_1_Office;
...
category = 'Office'
;
--42958579 41873188 select count(*) from tmp_7d.kn_mbm_lopa_tracking_1_Office

drop table tmp_7d.kn_mbm_lopa_tracking_1_Chiro ;
...
category = 'Chiro'
;
--5852250 select count(*) from tmp_7d.kn_mbm_lopa_tracking_1_Chiro


drop table tmp_7d.kn_mbm_lopa_tracking_2_category;
...
select * from tmp_1m.kn_mbm_episode_2_202508 limit 5;

drop table tmp_7d.kn_mbm_lopa_tracking_2_paid;
...
proc_cd
;
--70720781 51342718 select count(*) from tmp_7d.kn_mbm_lopa_tracking_2_paid
--select * from tmp_7d.kn_mbm_lopa_tracking_2_paid where allowed_amt <2 Note: keep Paid status even if the paid amount is $0

drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid;
...
drop table tmp_7d.kn_mbm_ever_lopa;
...
where lopa_flg = 1
;
--1896320 1660318 select count(distinct mbi||start_dt||proc_cd) from tmp_7d.kn_mbm_ever_lopa

--overturn is higher priority than still lopa
drop table tmp_7d.kn_mbm_ever_lopa_overturn; 
...
;
--414235 325411 select count(*) from tmp_7d.kn_mbm_ever_lopa_overturn

drop table tmp_7d.kn_mbm_ever_lopa_still;
...
where still_lopa = 1
;
--1564966 1334907 select count(*) from tmp_7d.kn_mbm_ever_lopa_still


drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_1;
...
a.proc_cd = b.proc_cd
;
--74609604 select count(*) from tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_1
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_2;
...
--74609604 select count(*) from tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_2
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa;
...
;
--74609604 select count(*) from tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa
--check
...
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_4;
...
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_4_market;
...
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_summary_market;
...
--summary for excel
drop table tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_summary;
...
select sum(visit_proc_cnt) from tmp_7d.kn_mbm_lopa_tracking_3_cat_paid_lopa_summary
;