...
create temporary table tmp_7d.kn_mbm_dtl stored as orc as 					
select 			
	fin_mbi_hicn_fnl			
	, fin_inc_month			
	, fin_inc_qtr 		
...
select count(*) from tmp_7d.kn_mbm_dtl;  -- 430370488 415060257  407463331 399836379   392256742 (removed 2019) 442855070  435558291  428264965  450161568
...
create temporary table tmp_1m.kn_mbm_mshp stored as orc as 							
select 							
...
select count(*) from tmp_1m.kn_mbm_mshp; --9743  9606
...
select count(*) from tmp_1m.kn_mbm_mshp_sum1; -- 134 132 128 126 124  144 142
...
select count(*) from tmp_1y.kn_lopa_op_1; -- 2484707 2417275  2306199  2164101  1729931 1526791   1338831
...
select count(*) from tmp_1y.kn_lopa_op; -- 2417275  2306199 2164101
...
select count(*) from tmp_1y.kn_lopa_pr_1; -- 3714719  3501938 3263702
...
select count(*) from tmp_1y.kn_lopa_pr; -- 3714719  3501938 3263702
...
select count(*) from tmp_1y.kn_mbm_episode_1; -- 64354173  62711063  60990327
...
select count(*) from tmp_1y.kn_mbm_claims; -- 77536654  75713104  73889849     72274650
...
select			
	...
	, count(distinct a.eventkey) as visits                     		
	, sum(a.adj_srvc_unit_cnt) as adj_srvc_units		
from tmp_1y.kn_mbm_claims as a
left join tmp_1y.kn_lopa_op as b
	on concat(a.gal_mbi_hicn_fnl, "_", a.fst_srvc_dt) = b.total_mbi_dos 
    and a.proc_cd = b.proc_cd
    and a.prov_tin = b.prov_tin
...
select count(*) from tmp_1y.kn_mbm_episode_1b; -- 38657890  37706450  36737912  35885437
...
drop table tmp_1m.kn_mbm_episode_1c;
create table tmp_1m.kn_mbm_episode_1c as
select * from tmp_1m.kn_mbm_episode_1
union all
select * from tmp_1y.cl_mbm_episode_1_2018_2020
union all
select * from tmp_1m.kn_mbm_episode_1b
union all
select * from tmp_1y.cl_mbm_episode_1b_2018_2020
;

select sum(visits) as n from tmp_1m.kn_mbm_episode_1c
...
drop table tmp_1m.kn_mbm_episode_2; 
...
select count(*) from tmp_1m.kn_mbm_episode_2; -- 134268620 141253070  138658520  135969246

describe formatted tmp_1m.kn_mbm_episode_2;
...
select count(*) from tmp_1m.kn_mbm_episode_3; -- 64545494 63423287 66929218  65797555     64650521

drop table tmp_1m.kn_mbm_episode_4;  
...
select 
	...
	, vsts
	, adj_srvc_units
from tmp_1m.kn_mbm_episode_3 as a
;

select count(*) from tmp_1m.kn_mbm_episode_4; -- 64545494 66929218  65797555   64650521

drop table tmp_1m.kn_mbm_episode_lag ;
...
select count(*) from tmp_1m.kn_mbm_episode_lag; -- 64545494 66929218  65797555  64650521
...
drop table tmp_1m.kn_mbm_episode_vst_ep_2;  
...
from (select *  
	  ...
	  from tmp_1m.kn_mbm_episode_lag ) as a
;

select count(*) from tmp_1m.kn_mbm_episode_vst_ep_2; -- 66929218  65797555  64650521

drop table tmp_1m.kn_mbm_episode_smry;  
...
select count(*) from tmp_1m.kn_mbm_episode_smry; -- 1555388  1526174  1496541
...
drop table tmp_1m.kn_mbm_episode_ro_lag;  
...
select count(*) from tmp_1m.kn_mbm_episode_ro_lag; -- 66929218  65797555  64650521

drop table tmp_1m.kn_mbm_episode_ro_lag2;  
...
select 
	...
	, allowed
	, 0 as mm 
from tmp_1m.kn_mbm_episode_ro_lag as a
;


select ep_start_mo, count(episodes) from tmp_1m.kn_mbm_episode_ro_lag2
where episodes = 1
group by ep_start_mo

select count(*) from tmp_1m.kn_mbm_episode_ro_lag2; -- 66929218  65797555  64650521

drop table tmp_1m.kn_mbm_episode_agg6_ep;  
...
select 
	...
	, 0 as allowed
	, 0 as mm 
from (select * from tmp_1m.kn_mbm_episode_ro_lag2 where episodes = 1 ) as a
group by 
	ep_start_mo
...
select count(*) from tmp_1m.kn_mbm_episode_agg6_ep; -- 45630  44961 44193  43381

/*==============================================================================
 * COMBINE VISITS AND EPISODES
 *==============================================================================*/

drop table tmp_1m.kn_mbm_episode_agg6;  
...
select count(*) from tmp_1m.kn_mbm_episode_agg6; -- 2322113  2278610 2234635

insert into tmp_1m.kn_mbm_episode_agg6   
select * from tmp_1m.kn_mbm_episode_agg6_ep as a;
...
select count(*) from tmp_1m.kn_mbm_episode_agg6; --2089616 2367743  2323571  2278828  2235149
...
drop table tmp_1m.kn_mbm_episode_agg6_sum1_after2023;
create table tmp_1m.kn_mbm_episode_agg6_sum1_after2023 stored as orc as 
select 
	data_type,
	ep_start_mo,
...
;
select count(*) from tmp_1m.kn_mbm_episode_agg6_sum1_after2023; -- 72856


drop table tmp_1y.kn_mbm_episode_agg6_sum1_before2023;
...
drop table tmp_1m.kn_mbm_202507;
create table tmp_1m.kn_mbm_202507 as
select
	*
from tmp_1m.kn_mbm_episode_agg6_sum1_after2023
union all
select 
	*
from tmp_1y.kn_mbm_episode_agg6_sum1_before2023;

select count(*) from tmp_1m.kn_mbm_202507; -- 249344
;
