...
drop table if exists tmp_1m.kn_mbm_dtl_202511;					
create table tmp_1m.kn_mbm_dtl_202511 stored as orc as 					
select 			
	fin_mbi_hicn_fnl			
	, fin_inc_month			
	, fin_inc_qtr 		
...
-- select count(*) from tmp_1m.kn_mbm_dtl_202511;  -- 476794132 430370488 415060257  407463331 399836379   392256742 (removed 2019) 442855070  435558291  428264965  450161568
...
drop table if exists tmp_1m.kn_mbm_mshp_202511; 							
create temporary table tmp_1m.kn_mbm_mshp_202511 stored as orc as 							
select 							
...
from tmp_1m.kn_mbm_dtl_202511 as a
where global_cap = 1
group by 							
	fin_inc_month							
...
-- select count(*) from tmp_1m.kn_mbm_mshp_202511; --9743  9606

drop table if exists tmp_1m.kn_mbm_mshp_sum1_202511;
create table tmp_1m.kn_mbm_mshp_sum1_202511 stored as orc as
select 
	'MM' as data_type
	, ep_start_mo
	, '' as visit_mo
	...
	, 0 as allowed_amt
	, sum(mm) as mms
from tmp_1m.kn_mbm_mshp_202511
...
--select count(*) from tmp_1m.kn_mbm_mshp_sum1_202511; -- 142 134 132 128 126 124  144 142

--select * from tmp_1m.kn_mbm_mshp_sum1_202511;
...
drop table if exists tmp_1m.kn_lopa_op_1_202511;
create table tmp_1m.kn_lopa_op_1_202511 as
select  
...
describe formatted tmp_1y.pa_trckng_op_evnt_lopa_dtl_mbm_therapy


--select count(*) from tmp_1m.kn_lopa_op_1_202511; -- 2484707 2417275  2306199  2164101  1729931 1526791   1338831

drop table if exists tmp_1m.kn_lopa_op_202511;
create table tmp_1m.kn_lopa_op_202511 as
select 
	case when still_lopa_mbi_dos is not null or overturn_lopa_mbi_dos is not null then mbi_dos else null end as ever_lopa
	, *
from tmp_1m.kn_lopa_op_1_202511
; 

--select count(*) from tmp_1m.kn_lopa_op_202511; -- 2417275  2306199 2164101

drop table if exists tmp_1m.kn_lopa_pr_1_202511;
create table tmp_1m.kn_lopa_pr_1_202511 as
select  
...
--select count(*) from tmp_1m.kn_lopa_pr_1_202511; -- 3714719  3501938 3263702

drop table if exists tmp_1m.kn_lopa_pr_202511;
create table tmp_1m.kn_lopa_pr_202511 as
select 
	case when still_lopa_mbi_dos is not null or overturn_lopa_mbi_dos is not null then mbi_dos else null end as ever_lopa
	, *
from tmp_1m.kn_lopa_pr_1_202511
;

--select count(*) from tmp_1m.kn_lopa_pr_202511; -- 3714719  3501938 3263702
...
drop table if exists tmp_1m.kn_mbm_episode_pr_202511; 
create table tmp_1m.kn_mbm_episode_pr_202511 stored as orc as
select			
...
left join tmp_1m.kn_lopa_pr_202511 as b		   
...
--select count(*) from tmp_1m.kn_mbm_episode_pr_202511; -- 64354173  62711063  60990327



--select sum(allowed) from tmp_1m.kn_mbm_episode_pr_202511
...
drop table if exists tmp_1m.kn_mbm_episode_op_202511; 
create table tmp_1m.kn_mbm_episode_op_202511 as 
select			
	a.gal_mbi_hicn_fnl as mbi		
	, a.component		
	, a.eventkey as id		
...
left join tmp_1m.kn_lopa_op_202511 as b
	on concat(a.gal_mbi_hicn_fnl, "_", a.fst_srvc_dt) = b.total_mbi_dos 
    and a.proc_cd = b.proc_cd
    and a.prov_tin = b.prov_tin
...
--select count(*) from tmp_1m.kn_mbm_episode_op_202511; -- 40613266 38657890  37706450  36737912  35885437

select count(*) from tmp_1m.kn_mbm_episode_op_202510;
...
select count(*) from tmp_1y.cl_mbm_episode_1_2018_2020
;
...
drop table if exists tmp_1m.kn_mbm_episode_1c_202511;
create table tmp_1m.kn_mbm_episode_1c_202511 as
select * from tmp_1m.kn_mbm_episode_pr_202511
union all
select * from tmp_1y.kn_mbm_episode_pr_2018_2020
union all
select * from tmp_1m.kn_mbm_episode_op_202511
union all
...
--select count(*) from tmp_1m.kn_mbm_episode_1c_202511; -- 146949829 136759944 134268620 141253070  138658520  135969246
--
--select * from tmp_1m.kn_mbm_episode_1c_202511 limit 2;
--select serv_month, sum(allowed) as allowedamt 
--from tmp_1m.kn_mbm_episode_1c_202511
...
drop table if exists tmp_1m.kn_mbm_episode_2_202511; 
create table tmp_1m.kn_mbm_episode_2_202511 as 			
select			
	*			
...
from (select a.*, tin_num  			
      from (select *
             ...
             from tmp_1m.kn_mbm_episode_1c_202511) as a 			
             left join tmp_1y.p8001_optum_tin_2 as b 			
             on prov_tin = tin_num 			
             and i = 1 ) as b 	
;

--select count(*) from tmp_1m.kn_mbm_episode_2_202510; -- 146949829 134268620 141253070  138658520  135969246
--
--describe formatted tmp_1m.kn_mbm_episode_2_202511;

select serv_month, sum(allowed) as allowedamt 
from tmp_1m.kn_mbm_episode_2_202510
where serv_month = '202406'  
...
drop table if exists tmp_1m.kn_mbm_episode_3_202511;  
create table tmp_1m.kn_mbm_episode_3_202511 as 
select			
...
from tmp_1m.kn_mbm_episode_2_202511
...
--select count(*) from tmp_1m.kn_mbm_episode_3_202510; -- 69136216 64545494 63423287 66929218  65797555     64650521

drop table if exists tmp_1m.kn_mbm_episode_4_202511;  
create table tmp_1m.kn_mbm_episode_4_202511 as  			
select 
	mbi
	, component
	, id
	...
	, vsts
	, adj_srvc_units
from tmp_1m.kn_mbm_episode_3_202511 as a
;

--select count(*) from tmp_1m.kn_mbm_episode_4_202511; -- 64545494 66929218  65797555   64650521
--
--drop table if exists tmp_1m.kn_mbm_episode_lag_202511 ;
--create table tmp_1m.kn_mbm_episode_lag_202511 as 
--select 
--	*
...
select a.mbi
	...
	, a.vsts
	, a.adj_srvc_units
from tmp_1m.kn_mbm_episode_4_202511 as a
left join tmp_1m.kn_mbm_episode_4_202511 as b 
	on a.mbi = b.mbi 
	and a.mbm_deploy_dt = b.mbm_deploy_dt
	and a.i = b.i+1 
;

--select count(*) from tmp_1m.kn_mbm_episode_lag_202511; -- 64545494 66929218  65797555  64650521
-- 
/*==============================================================================
...
drop table if exists tmp_1m.kn_mbm_episode_vst_ep_2_202511;  
create table tmp_1m.kn_mbm_episode_vst_ep_2_202511 as  
select a.mbi
	, a.component
	, a.id
	, a.start_dt
...
from (select *  
	  ...
	  from tmp_1m.kn_mbm_episode_lag_202511 ) as a
;

--select count(*) from tmp_1m.kn_mbm_episode_vst_ep_2_202511; -- 66929218  65797555  64650521

drop table if exists tmp_1m.kn_mbm_episode_smry_202511;  
create table tmp_1m.kn_mbm_episode_smry_202511 as  
select  
...
from tmp_1m.kn_mbm_episode_vst_ep_2_202511 as a
group by 
	a.serv_month  
...
select count(*) from tmp_1m.kn_mbm_episode_smry_202510;
--select count(*) from tmp_1m.kn_mbm_episode_smry_202511; -- 1479372 1555388  1526174  1496541
--  
/*==============================================================================
...
drop table if exists tmp_1m.kn_mbm_episode_ro_lag_202511;  
create table tmp_1m.kn_mbm_episode_ro_lag_202511 as  
select a.mbi
	, a.component
	, a.id
	, a.start_dt
...
--select count(*) from tmp_1m.kn_mbm_episode_ro_lag_202511; -- 66929218  65797555  64650521

drop table if exists tmp_1m.kn_mbm_episode_ro_lag2_202511;  
create table tmp_1m.kn_mbm_episode_ro_lag2_202511 as  
select 
	a.mbi
	, a.id
	, ep_start_dt
	...
	, allowed
	, 0 as mm 
from tmp_1m.kn_mbm_episode_ro_lag_202511 as a
;
--
--
--select ep_start_mo, count(episodes) from tmp_1m.kn_mbm_episode_ro_lag2_202511
--where episodes = 1
--group by ep_start_mo
--
--select count(*) from tmp_1m.kn_mbm_episode_ro_lag2_202510; -- 66929218  65797555  64650521

drop table if exists tmp_1m.kn_mbm_episode_agg6_ep_202511;  
create table tmp_1m.kn_mbm_episode_agg6_ep_202511 as  
select 
	...
	, 0 as allowed
	, 0 as mm 
from (select * from tmp_1m.kn_mbm_episode_ro_lag2_202511 where episodes = 1 ) as a
group by 
	ep_start_mo
...
;
--
--select count(*) from tmp_1m.kn_mbm_episode_agg6_ep_202510; -- 46496 45630  44961 44193  43381
...
drop table if exists tmp_1m.kn_mbm_episode_agg6_202511;  
create table tmp_1m.kn_mbm_episode_agg6_202511 as  
select 
	'VISITS' as data_type
	, ep_start_mo 
	, concat(ep_start_year,'Q9') as ep_start_qtr
	...
	, sum(allowed) as allowed
	, 0 as mm 
from tmp_1m.kn_mbm_episode_ro_lag2_202511
group by 
	ep_start_mo 
	, concat(ep_start_year,'Q9') 
	, market_fnl
...
--select count(*) from tmp_1m.kn_mbm_episode_agg6_202510; -- 2198844 2322113  2278610 2234635

insert into tmp_1m.kn_mbm_episode_agg6_202511   
select * from tmp_1m.kn_mbm_episode_agg6_ep_202511 as a;

---- Minor format adjustments
---- Considering removing because of formatting issues
alter table tmp_1m.kn_mbm_episode_agg6_202511 change data_type data_type varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change ep_start_mo ep_start_mo varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change ep_start_qtr ep_start_qtr varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change mbm_deploy_dt mbm_deploy_dt varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change claim_status claim_status varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change visit_mo visit_mo varchar(20);
alter table tmp_1m.kn_mbm_episode_agg6_202511 change category category varchar(20);
--
--select count(*) from tmp_1m.kn_mbm_episode_agg6_202511; --2245340 2089616 2367743  2323571  2278828  2235149
--
--
--
--
...
--
--select sum(allowed) 
--from tmp_1m.kn_mbm_episode_agg6_202511
--where visit_mo = '202406'; --73246897.76 73520205.78 73432103.42  73635236.05  73514079.66
...
drop table if exists tmp_1m.kn_mbm_episode_agg6_sum1_after2023_202511;
create table tmp_1m.kn_mbm_episode_agg6_sum1_after2023_202511 stored as orc as 
select 
	data_type,
	ep_start_mo,
...
select 
	...
	allowed_amt,
	mms
from tmp_1m.kn_mbm_mshp_sum1_202511
;
--select count(*) from tmp_1m.kn_mbm_episode_agg6_sum1_after2023_202510; -- 89653 72856
...
drop table if exists tmp_1m.kn_mbm_202511;
create table tmp_1m.kn_mbm_202511 as
select
	*
from tmp_1m.kn_mbm_episode_agg6_sum1_after2023_202511
union all
select 
	*
from tmp_1y.kn_mbm_episode_agg6_sum1_before2023;

select count(*) from tmp_1m.kn_mbm_202510; -- 266213 257905 253665
;
