...
describe tadm_tre_cpy.GL_RSTD_GPSGALNCE_f_202510;
...
--6849 5414  4736  select count(*) from tmp_1m.kn_synapse_GA_NC_mbi_202510
...
describe tmp_1m.kn_mbi_ga_nc_aco_202510;

describe tmp_1m.kn_synapse_ga_nc_claims_202510;

select distinct
	prov_tin
from tmp_1m.kn_synapse_ga_nc_claims_202510
where prov_tin in 
('043743987'
,'264279439'
,'351162212'
...
select count(*) from tmp_1m.kn_mbi_ga_nc_aco_202510;   -- 2,809,492 2,046,411  1531518

select count(distinct fin_mbi_hicn_fnl ||  fin_inc_month) from tmp_1m.kn_mbi_ga_nc_aco_202510;  -- 2809492 2046411  1531518 
