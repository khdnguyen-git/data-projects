...
drop table tmp_1m.kn_mbi_aco;
create table tmp_1m.kn_mbi_aco as
select DISTINCT
fin_mbi_hicn_fnl
,fin_inc_month
,hierarchy
...
select tfm_include_flag from tmp_1y.cl_synapse_hcpcs_20250212
create table 
...
group by
    ...
    , a.fin_inc_year
;
/*--27284 select count(*) from tmp_1m.kn_synapse_caprate_membership_claims_sum*/
select 
    sum(allowed) 
