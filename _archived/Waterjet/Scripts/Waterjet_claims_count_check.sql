...
-- Comment: Including clm_aud_nbr to compare n with unique_id
...
select 
	...
	, count(proc_cd) as n_proc
from tmp_1m.kn_waterjet_cosmos_csp_nice_claims_check
where fst_srvc_month >='202402' and fst_srvc_month <= '202501'
	and entity = 'COSMOS'
group by 
	component
	, case 
...
select * from tmp_1m.kn_waterjet_proc_check
