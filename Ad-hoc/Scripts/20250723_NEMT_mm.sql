...
select count(*) from tmp_1m.kn_nemt_cosmos_csp_nice_claims;
-- 11493953


-- All Membership;
create table tmp_1m.kn_nemt_membership as
...
select count(*) from tmp_1m.kn_nemt_membership; -- 219533511

select * from tmp_1m.kn_nemt_membership
limit 2;

select * from tmp_1m.kn_nemt_cosmos_csp_nice_claims
limit 2;

drop table tmp_1m.kn_nemt_claim_mm;
create table tmp_1m.kn_nemt_claim_mm as
select
	a.entity
	, a.entity1
	, a.population
	...
	, a.pd
	, b.mm
from tmp_1m.kn_nemt_cosmos_csp_nice_claims as a 
left join tmp_1m.kn_nemt_membership as b
...
select count(*) from tmp_1m.kn_nemt_claim_mm;

drop table tmp_1m.kn_nemt_claim_mm_sum;
create table tmp_1m.kn_nemt_claim_mm_sum as
select 
	a.entity
	, a.population
	, a.unique_id
	...
	, sum(a.pd) as paid
	, sum(a.mm) as mms
from tmp_1m.kn_nemt_claim_mm as a
group by 
	a.entity
	, a.population
	, a.unique_id
	...
	, a.product_level_3_fnl
;
drop table tmp_1m.kn_nemt_claim_mm_sum_filtered;
create table tmp_1m.kn_nemt_claim_mm_sum_filtered as
select 
	* 
from tmp_1m.kn_nemt_claim_mm_sum
where global_cap = 'NA'
and clm_dnl_f = 'N'
...
select count(*) from tmp_1m.kn_nemt_claim_mm_sum_filtered;

select * from tmp_1m.kn_nemt_claim_mm_sum_filtered
where 
