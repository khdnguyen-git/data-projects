...
select count(*) from tmp_1m.kn_transplant_op_pr_claims; -- 559452

select count(*) from tmp_1m.kn_transplant_op_claims; -- 16995
select count(*) from tmp_1m.kn_transplant_pr_claims; -- 542457
...
select * from tmp_1m.kn_transplant_cosmos_ip;
select * from tmp_1m.kn_transplant_smart_ip;
select * from tmp_1m.kn_transplant_nice_ip;
...
select count(*) from tmp_1m.kn_transplant_cosmos_ip_sum; -- 25630

select count(*) from tmp_1m.kn_transplant_smart_ip_sum; -- 25630

select count(*) from tmp_1m.kn_transplant_nice_ip_sum; -- 25630
...
select count(*) from tmp_1m.kn_transplant_ip_claims; -- 26,559
