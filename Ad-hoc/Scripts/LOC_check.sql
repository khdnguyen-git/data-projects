...
--9/10/25: done; it's September but there's no September enrollment table so it still says 202508--
...
--9/10/25: done; no new enrollment table--
...
drop table if exists tmp_1m.kn_avtar_22_trs;
create table tmp_1m.kn_avtar_22_trs as
select 
...
FROM
	hce_ops_fnl.trs_data_set_fnl as a
left outer join
	hce_ops_fnl.hce_adr_avtar_like_2022_f_1 as b
...
select transplant_flag from hce_ops_fnl.hce_adr_avtar_like_2022_f_1;

select * from hce_ops_fnl.hce_adr_avtar_like_2022_f_1;


--Step 2.2: Union non-notification TRS to rest of notifications
drop table if exists tmp_1m.kn_avtar_22_trs_combined;
create table tmp_1m.kn_avtar_22_trs_combined as
select 
	* from hce_ops_fnl.hce_adr_avtar_like_2022_f_1
union all select
	* from tmp_1m.kn_avtar_22_trs
	;

--Step 2.3: Adding variable to split PAC from IPA 
drop table if exists tmp_1m.kn_avtar_22_1_trs;
create table tmp_1m.kn_avtar_22_1_trs as
select 
	a.*
...
drop table if exists tmp_1m.kn_avtar_22_2_trs;
create table tmp_1m.kn_avtar_22_2_trs as
select     
	*
...
drop table if exists tmp_1m.kn_avtar_22_3_trs;
create table tmp_1m.kn_avtar_22_3_trs as
select 
	a.*
...
drop table if exists tmp_1m.kn_avtar_23_trs;
create table tmp_1m.kn_avtar_23_trs as
select 
	0 as p2p_full_evertouched_cnt
	,0 as p2p_full_ovtn
	,'0' as p2p_match_ind
...
FROM
	hce_ops_fnl.trs_data_set_fnl as a
left outer join
	hce_ops_fnl.hce_adr_avtar_like_2023_f_1 as b
on  b.transplant_flag='Y'
and a.fin_mbi_hicn_fnl = b.fin_mbi_hicn_fnl
...
drop table if exists tmp_1m.kn_avtar_23_trs_combined;
create table tmp_1m.kn_avtar_23_trs_combined as
select 
...
drop table if exists tmp_1m.kn_avtar_23_1_trs;
create table tmp_1m.kn_avtar_23_1_trs as
select 
	a.*
	,cast(admission_date as date) as trs_admit_dt
	,cast(transplantdate as date) as trs_transplant_dt
...
drop table if exists tmp_1m.kn_avtar_23_2_trs;
create table tmp_1m.kn_avtar_23_2_trs as
select     
	*
	,case when ip_type in ('Medical','Surgical','Transplant') and admit_dt_act is not null then admit_dt_act
		when ip_type in ('Transplant') and admit_dt_act is null and admission_date is not null then trs_admit_dt
...
drop table if exists tmp_1m.kn_avtar_23_3_trs;
create table tmp_1m.kn_avtar_23_3_trs as
select 
	a.*
	,concat(lpad(year(a.hcedt),4,0),lpad(month(a.hcedt),2,0)) as hce_admit_month
	,cast(hcedt as date) as hce_dt
...
drop table if exists tmp_1m.kn_avtar_24_25_trs;
create table tmp_1m.kn_avtar_24_25_trs as
select 
	0 as p2p_full_evertouched_cnt
	,0 as p2p_full_ovtn
	,'0' as p2p_match_ind
...
FROM
	hce_ops_fnl.trs_data_set_fnl as a
left outer join
	hce_ops_fnl.hce_adr_avtar_like_24_25 as b
on  b.transplant_flag='Y'
and a.fin_mbi_hicn_fnl = b.fin_mbi_hicn_fnl
where b.fin_mbi_hicn_fnl is null and year(a.transplantdate)>2023
;
...
drop table if exists tmp_1m.kn_avtar_24_25_trs_combined;
create table tmp_1m.kn_avtar_24_25_trs_combined as
select 
	* from hce_ops_fnl.hce_adr_avtar_like_24_25
union all select
...
drop table if exists tmp_1m.kn_avtar_24_25_1;
create table tmp_1m.kn_avtar_24_25_1 as
select 
	a.*
	,cast(admission_date as date) as trs_admit_dt
	,cast(transplantdate as date) as trs_transplant_dt
...
drop table if exists tmp_1m.kn_avtar_24_25_2;
create table tmp_1m.kn_avtar_24_25_2 as
select     
	*
	,case when ip_type in ('Medical','Surgical','Transplant') and admit_dt_act is not null then admit_dt_act
		when ip_type in ('Transplant') and admit_dt_act is null and admission_date is not null then trs_admit_dt
...
drop table if exists tmp_1m.kn_avtar_24_25_3;
create table tmp_1m.kn_avtar_24_25_3 as
select 
	a.*
	,concat(lpad(year(a.hcedt),4,0),lpad(month(a.hcedt),2,0)) as hce_admit_month
	,cast(hcedt as date) as hce_dt
...
drop table if exists tmp_1m.kn_ip_dataset_09172025_trs; 
create table tmp_1m.kn_ip_dataset_09172025_trs as 
select 
	admit_week
	,hce_dt
	,hce_admit_month
...
drop table if exists tmp_1m.kn_ip_dataset_09172025_2_trs; 
create table tmp_1m.kn_ip_dataset_09172025_2_trs as 
select 
	a.*
...
drop table if exists tmp_1m.kn_ip_dataset_09172025_3_trs; 
create table tmp_1m.kn_ip_dataset_09172025_3_trs as 
select 
	*
...
drop table if exists tmp_1m.kn_ip_dataset_09172025_4_trs; 
create table tmp_1m.kn_ip_dataset_09172025_4_trs as 
select 	
	a.admit_week
	,a.hce_admit_month
--	,a.admit_act_qtr
...
drop table if exists tmp_1m.kn_ip_dataset_09172025_mm; 
create table tmp_1m.kn_ip_dataset_09172025_mm as 
select 
...
--	,'MM' as prim_diag_ahrq_genl_catgy_desc 
	...
	,0 as franky_admits
	,0 as franky_allw
from tadm_tre_cpy.gl_rstd_gpsgalnce_f_202508 /**/ as a /*MAKE SURE THIS IS EITHER ENROLLMENT TABLE FOR CURRENT MONTH OR TRE_MEMBERSHIP*/
...
drop table if exists tmp_1m.kn_ip_dataset_notif_09172025_trs;
...
drop table if exists tmp_1y.kn_ip_dataset_claims_cosmos_2021;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_cosmos_09172025;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_cosmos_09172025_2;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky1;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky2 ;
...
select *
	...
	,datediff(pd_dn_ol_admit_end_dt ,pd_dn_ol_admit_start_dt )+1 as days1 
from tmp_1m.kn_ip_dataset_claims_franky1
;
select *
	,case when date_add(last_day(adjd_dt),-10)>=adjd_dt then date_format(adjd_dt,'yyyyMM') else date_format(add_months(adjd_dt,1),'yyyyMM') end as adjd_yrmonth
from tmp_1m.kn_ip_dataset_claims_franky2
where  gal_mbi_hicn_fnl='3WR0VH2MW48' and pd_dn_ol_admit_start_dt='2021-01-03';

--Step 15: If the running total of paid dollars is >0, then we count give it a 1
drop table if exists tmp_1m.kn_ip_dataset_claims_franky3 ;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky4 ;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky5 ;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky6 ;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky7 ;
...
drop table if exists tmp_1m.kn_ip_dataset_claims_franky8_09172025 ;
...
select sum(allw_franky) as net_pd_franky, sum(units_franky) as units_franky , sum(days_franky) as days_franky from tmp_1m.kn_ip_dataset_claims_franky6;
--NOVEMBER
...
select sum(allw_franky) as net_pd_franky, sum(units_franky) as units_franky , sum(days_franky) as days_franky from tmp_1m.kn_ip_dataset_claims_franky7;
--NOVEMBER
...
drop table if exists tmp_1m.kn_ip_dataset_claims_cosmos_franky; 
create table tmp_1m.kn_ip_dataset_claims_cosmos_franky as 
select
	a.admit_week
...
drop table if exists tmp_1m.kn_ip_dataset_claims_triangle_09172025; 
create table tmp_1m.kn_ip_dataset_claims_triangle_09172025 as 
SELECT
	000000 as admit_week
	,admit_yr_month
	,'0000' as admit_year
...
--Step 23: NICE pull
drop table if exists tmp_1m.kn_ip_dataset_claims_nice; 
create table tmp_1m.kn_ip_dataset_claims_nice as 
SELECT
/*CLAIM-RELATED FIELDS*/
	a.CLM_AUD_NBR
	,a.COMPONENT
...
drop table if exists tmp_1m.kn_ip_dataset_claims_facet;
create table tmp_1m.kn_ip_dataset_claims_facet as
select 
	a.admit_start_dt
    ,a.admit_end_dt
...
drop table if exists tmp_1m.kn_ip_dataset_claims_trs; 
create table tmp_1m.kn_ip_dataset_claims_trs as 
select
	a.admit_week
	,a.tadm_admit_type
	,a.admit_yr_month 
...
--	,a.fst_srvc_month
	...
	,a.dkn_risk_type_fnl as nce_tadm_dec_risk_type
	,a.group_ind_fnl 
	,a.market_fnl 
	,a.GROUPNUMBER
	,b.group_name
	...
	,datediff(a.admit_end_dt,a.admit_start_dt)+1 as los_clms
	,0 as length_of_stay
	,case when a.dkn_risk_type_fnl in ('FFS','PHYSICIAN') then 0 else 1 end as capitated
	,'NICE' as global_cap
	,a.tadm_admits 
	,a.net_pd_amt_fnl 
	,a.allw_amt_fnl 
...
drop table if exists tmp_1m.kn_ip_dataset_claims_fnl_trs_09172025; 
create table tmp_1m.kn_ip_dataset_claims_fnl_trs_09172025 as 
select	
	admit_week
	,admit_yr_month
	,'0000' as admit_year
...
drop table if exists tmp_1m.kn_ip_dataset_all_09172025_trs;
...
union all select 
	* 
	from tmp_1m.kn_ip_dataset_claims_fnl_trs_09032025 /*REFLECT OLD DATE UNLESS CLAIMS UPDATE; last claims update 8/27/25: should be *08272025*/ 
	/*For 9/10 update this should be 09032025 - will remain until September claims*/ 
union all select 
	* 
	from tmp_1m.kn_ip_dataset_claims_triangle_09032025 /*REFLECT OLD DATE UNLESS CLAIMS UPDATE; last claims update 8/27/25: should be *08272025*/ 
	/*For 9/10 update this should be 09032025 - will remain until September claims*/ 
	; 
...
drop table if exists tmp_1m.kn_ip_dataset_pac_navi ;
create table tmp_1m.kn_ip_dataset_pac_navi as
select 
	a.*
	,b.contract
	,b.market
...
drop table if exists tmp_1m.kn_ip_dataset_pac_navi_2 ;
create table tmp_1m.kn_ip_dataset_pac_navi_2 as
select 	
	a.*
...
drop table if exists tmp_1m.kn_ip_dataset_pac_fnl_09172025 ;
create table tmp_1m.kn_ip_dataset_pac_fnl_09172025 as
select 
	admit_type
...
drop table if exists tmp_1m.kn_ip_dataset_loc_09172025 ;
create table tmp_1m.kn_ip_dataset_loc_09172025 as
select 
	admit_week
...
drop table if exists tmp_1m.kn_ip_dataset_LI_09172025_trs ;
create table tmp_1m.kn_ip_dataset_LI_09172025_trs as
select 	
	admit_week
	,hce_admit_month
	,adjd_yrmonth
...
drop table if exists tmp_1m.kn_ip_dataset_LI_09172025_1_trs ;
create table tmp_1m.kn_ip_dataset_LI_09172025_1_trs as
select DISTINCT 	
	a.fin_tfm_product_new
	,a.admit_type
	,a.component
...
drop table if exists tmp_1m.kn_ip_dataset_LI_09172025_2_trs ;
create table tmp_1m.kn_ip_dataset_LI_09172025_2_trs as
select 
	admit_week
	,hce_admit_month
	,adjd_yrmonth
...
drop table if exists tmp_1m.kn_ip_dataset_LI_09172025_3_trs ;
create table tmp_1m.kn_ip_dataset_LI_09172025_3_trs as
select 
	admit_week
	,hce_admit_month
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_1;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_2a;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_2b;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_2;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_3;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_4;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_5;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_6;
...
--drop table if exists tmp_2y.kn_ip_mm_2024;
...
drop table if exists tmp_1m.kn_ip_mm_2025;
...
--	AND global_cap='NA'
--	AND sgr_source_name='COSMOS'
--	AND fin_product_level_3 <>'INSTITUTIONAL'_
--	AND fin_product_level_3 <>'INSTITUTIONAL'
--	AND tfm_include_flag=1 
-- 	AND fin_tfm_product_new in ('HMO','PPO','NPPO','DUAL_CHRONIC')
-- union all	
...
drop table if exists tmp_1m.kn_ip_mm_stack;
...
drop table if exists tmp_1m.kn_ip_mm_joiner;
...
drop table if exists tmp_1m.kn_ip_mm_leaver;
...
drop table if exists tmp_1m.kn_ip_mm_joiner2;
...
drop table if exists tmp_1m.kn_ip_mm_leaver2;
...
drop table if exists tmp_1m.kn_ip_dataset_comp_09172025_fnl;
...
--/*LOC valuation*/
--data hcx_ec.LOC_IP_9_10_25 (compress=yes); /*CHANGE TO CURRENT DATE*/
--set tmp_1m.kn_ip_dataset_loc_09172025
--;run;

--/*leading indicator*/
--data hcx_ec.kn_ip_dataset_9_10_2025 (compress=yes); /*CHANGE TO CURRENT DATE*/ 
